...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.grodankvackkvack \
    -o android/app/libs/grodankvackkvack.aar \
    ./mobile
...
echo "→ Lancement de Grodan and Kvack Kvack"
$adb_path shell am force-stop com.olivierh.grodankvackkvack
$adb_path shell am start -n com.olivierh.grodankvackkvack/.MainActivity
